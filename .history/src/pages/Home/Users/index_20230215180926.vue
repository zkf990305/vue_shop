<template>
    <div>
        ...
        <!-- 分配角色信息对话框 -->
        <set-roles
            :dialog-form-visible="setRolesDialogVisible"
            :userData="userInfo"
            @changeSetRolesDialogVisible="changeSetRolesDialogVisible"
        ></set-roles>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        // (分配角色子组件)父组件处理子组件发送的数据更改
        changeSetRolesDialogVisible(val) {
            this.setRolesDialogVisible = val
        },
        // 展示用户编辑的对话框
