<template>
    <div>
        ...
        <el-card>
            ...
            <!-- 角色列表区域 -->
            <el-table :data="rolesList" show-index border stripe>
                <!-- 展开列 -->
        ...
        <!-- 添加角色 -->
        <add-role
            :dialog-visible="addRoleDialogVisible"
            @changeAddRolesDialogVisible="changeAddRolesDialogVisible"
        ></add-role>
        <!-- 编辑角色 -->
        <edit-role
...
export default {
    ...
    methods: {
        ...
        changeAddRolesDialogVisible(val) {
